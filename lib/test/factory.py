#-*- coding: ISO-8859-1 -*-
# litesync/test/factory.py: tests for the various factories in pysqlite
#
...
def suite():
    ...
    return unittest.TestSuite((connection_suite, cursor_suite, row_suite, text_suite, text_zero_bytes_suite))
